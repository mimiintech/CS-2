/*
  ...
  THIS FILE. For the assignment, you should ONLY create the files
  `studentGrade.cpp` and `fileInputOutput.cpp`. This file defines the
  `main` function and prints output.
